...
function loopCountDownLoopBegin(loopCountDownLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    loopCountDown.forEach(function() {
...
function stimShufflerRoutineBegin(snapshot) {
  return async function () {
    ...
    stimShufflerComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function restPeriodRoutineBegin(snapshot) {
  return async function () {
    ...
    restPeriodComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function beginBlockRoutineBegin(snapshot) {
  return async function () {
    ...
    beginBlockComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function endStimRoutineBegin(snapshot) {
  return async function () {
    ...
    endStimComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function endFuncRunRoutineBegin(snapshot) {
  return async function () {
    ...
    endFuncRunComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
